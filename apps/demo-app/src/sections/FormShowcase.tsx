  ...
  return (
    <section className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData(prev => ({ ...prev, search: e.target.value }))}
          />
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <Checkbox
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData(prev => ({ ...prev, newsletter: e.target.checked }))}
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <Radio
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData(prev => ({ ...prev, plan: e.target.value }))}
          />
          <Radio
            name="plan"
            value="pro"
      ...
      <div className="space-y-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-6 bg-white dark:bg-secondary-800 rounded-xl border border-secondary-200 dark:border-secondary-700">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Input
              label="Full Name"
